...
function form_validation() {
    ...
    // می خواهیم ببینیم این فرم درخواست است یا فرم نوع تغییر
    // چون صحت سنجی این دو فرم با هم فرق دارد
    var form_type = $('input[name="form_type"]').val() || 'request'
    // در صورتی که فرم درخواست باشد، مقدار این متغییر صحیح خواهد بود
    // بنابراین شرط هایی که فقط مربوط به فرم درخواست است با این متغییر جمع می شود
    var request = false
    ...
    //////////////////////////////////بخش اول//////////////////////////
    //اطلاعات تغییر
    if (request && !$('[name="change_type"]').val()) {
 ...
 * @param {string} operation_type - نوع عملیات (یک کاراکتر، مثلاً 'A' یا 'D')
 */
function task_management(select_obj, operation_type, on_success)
{
    // مقادیر را از المان مورد نظر استخراج می کنیم
    const task_id = select_obj.data('task-id')
