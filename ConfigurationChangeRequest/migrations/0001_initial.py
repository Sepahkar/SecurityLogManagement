# Generated by Django 5.0.12 on 2025-08-30 19:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('change_location_systems', models.BooleanField(default=False, help_text='آیا تغییر در سیستم\u200cها انجام می\u200cشود؟', null=True, verbose_name='محل تغییر: سیستم\u200cها')),
                ...
                ('test_required', models.BooleanField(default=False, help_text='در صورتی که نیاز به تست داشته باشد مقدار یک و در غیر این صورت مقدار صفر خواهد داشت', null=True, verbose_name='نیازمند تست است؟')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_manager_nationalcode', models.ForeignKey(db_column='related_manager_nationalcode', on_delete=django.db.models.deletion.CASCADE, related_name='related_manager_natioanlcode', to='ConfigurationChangeRequest.user', verbose_name='کد ملی مدیر مربوطه')),
        ...
        migrations.AddField(
            model_name='notifygroup',
            name='team_code',
            field=models.ForeignKey(help_text='در صورتی این گروه مربوط به یک تیم است', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='notify_team_code', to='ConfigurationChangeRequest.role', verbose_name='کد سمت'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ConfigurationChangeRequest.requesttask', verbose_name='شناسه کاربر تسک')),
                ('task_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ConfigurationChangeRequest.taskuser', verbose_name='شناسه کاربر تسک')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notify_group_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ConfigurationChangeRequest.notifygroup', verbose_name='کد گروه اطلاع رسانی')),
                ('user_role_id', models.ForeignKey(db_column='user_role_id', help_text='لطفاً سمت فرد کاربر را وارد کنید.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='ConfigurationChangeRequest.role', verbose_name='سمت کاربر')),
                ('user_team_code', models.ForeignKey(blank=True, db_column='user_team_code', help_text='تیم مربوط به کاربر را انتخاب کنید.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='ConfigurationChangeRequest.team', verbose_name='تیم کاربر')),
                ('user_nationalcode', models.ForeignKey(db_column='user_nationalcode', on_delete=django.db.models.deletion.CASCADE, to='ConfigurationChangeRequest.user', verbose_name='کاربر مربوطه')),
            ],
